...
class ThanatosBot(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        cogs = ['cogs.loa_system', 'cogs.membership', 'cogs.contributions', 'cogs.configuration', 'cogs.backup', 'cogs.direct_messaging', 'cogs.database_management', 'cogs.enhanced_menu_system', 'cogs.audit_logs', 'cogs.event_management', 'cogs.enhanced_event_system']
    ...
    async def check_loa_expiration(self):
        """Background task to check for expired LOAs"""
        try:
